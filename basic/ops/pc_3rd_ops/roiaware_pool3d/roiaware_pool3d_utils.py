...
from pc_3rd_ops.roiaware_pool3d import roiaware_pool3d_cuda
...
def points_in_boxes_cpu(points, boxes):
    ...
    Args:
        points: (num_points, 3)
        boxes: [x, y, z, dx, dy, dz, heading], (x, y, z) is the bbox center, each bbox DO NOT overlaps
    Returns:
...
class RoIAwarePool3dFunction(Function):
    ...
    def forward(ctx, rois, pts, pts_feature, out_size, max_pts_each_voxel, pool_method):
        ...
        Args:
            ctx:
            rois: (N, 7) [x, y, z, dx, dy, dz, heading] (x, y, z) is the bbox center
            pts: (npoints, 3)
