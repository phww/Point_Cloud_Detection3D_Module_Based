...
class DataAugmentor(object):
    ...
    def __init__(self, root_path, augmentor_configs, class_names, logger=None):
        ...
        self.logger = logger
        self.reserved_feature_list = augmentor_configs.RESERVED_FEATURE
    ...
    # 数据库采样gt_boxes,以增加每个场景中gt_boxes的数量
    ...
    def forward(self, data_dict):
        ...
        # 每个场景只留下self.reserved_feature_list中的特征
        ...
        assert sorted(self.reserved_feature_list) == sorted(data_dict.keys()), "output features is incomplete"
        return data_dict
